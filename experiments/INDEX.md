...
| doc | role |
|---|---|
| [BENCHMARK-SPEC.md](BENCHMARK-SPEC.md) | Scoring design REGISTERED before data (lexicographic blocking rule, 2:1 weighted-recall convenience column, evaluator freeze). **ITERATION 1 COMPLETE; ITERATION 2 PARTIAL.** Final v2, both Opus columns, consensus, the first 18-cell shakedown table, its raw-data audit, and the harness follow-up landed. No lock-in verdict: iteration 2 is paused at a recoverable judge checkpoint while the judge design is reconsidered. |
