...
| [OPENAI-PROTOCOL-STUDY-SPEC.md](OPENAI-PROTOCOL-STUDY-SPEC.md) | **PRODUCERS COMPLETE; JUDGING IN PROGRESS:** all 144 fresh OpenAI causal-study calls completed with zero provider/format errors for $3.37301. Raw review refuted both exact simplifications and exposed a failed quiet control plus control over-interruption on proposed danger. The byte-identical blinded Sol judge is resuming with runner-only parallelism and a recorded $12 execution ceiling. |
