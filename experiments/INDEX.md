...
| [GOLDEN-V2-PROTOCOL-DECISION.md](GOLDEN-V2-PROTOCOL-DECISION.md) | **PROPOSED, awaiting Andreas — nothing in force.** The three prospective options after the failed bar (freeze with terminated dissent carried at the unanimous floor / fall back to v1 / let v2 die), with exact rule text for the recommended one. Registered while every v2 quality cell is still blank, so the choice cannot be tuned toward an arm. |
