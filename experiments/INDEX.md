...
| [ITERATION2-JUDGE-WAVE-SPEC.md](ITERATION2-JUDGE-WAVE-SPEC.md) | **REGISTERED, PARTIALLY SPENT, NOT APPLIED.** Scratch reconciliation recovered 25 fold-ready outcomes (including 19 adopted anchors), seven dataset-repair queue items, and six incomplete Sol-only residue votes. Old steps 3–5 are superseded by full expanded 2Q; the 67 atomized candidates are completeness leads only. `golden-dataset.json`, scores, and tracked artifacts remain unchanged pending Andreas's fold/residue decisions. |
